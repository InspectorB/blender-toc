...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "E1D272073E262A70D72F76A61D8F3A1D";
  static const uint8_t binary_fingerprint[16]; // = {0xE1,0xD2,0x72,0x07,0x3E,0x26,0x2A,0x70,0xD7,0x2F,0x76,0xA6,0x1D,0x8F,0x3A,0x1D};

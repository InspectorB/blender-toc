...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "29705A9A3D51C297EA87EAA7C390C91A";
  static const uint8_t binary_fingerprint[16]; // = {0x29,0x70,0x5A,0x9A,0x3D,0x51,0xC2,0x97,0xEA,0x87,0xEA,0xA7,0xC3,0x90,0xC9,0x1A};

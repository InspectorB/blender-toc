...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "73B33EA020067A503F3A371FFAC9986B";
  static const uint8_t binary_fingerprint[16]; // = {0x73,0xB3,0x3E,0xA0,0x20,0x06,0x7A,0x50,0x3F,0x3A,0x37,0x1F,0xFA,0xC9,0x98,0x6B};

...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "E4F44735142E038E68C6E465DBCFDDDD";
  static const uint8_t binary_fingerprint[16]; // = {0xE4,0xF4,0x47,0x35,0x14,0x2E,0x03,0x8E,0x68,0xC6,0xE4,0x65,0xDB,0xCF,0xDD,0xDD};

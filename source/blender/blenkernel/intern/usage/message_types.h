...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "DAE6CBE625CC5882E197538E4C3C2515";
  static const uint8_t binary_fingerprint[16]; // = {0xDA,0xE6,0xCB,0xE6,0x25,0xCC,0x58,0x82,0xE1,0x97,0x53,0x8E,0x4C,0x3C,0x25,0x15};

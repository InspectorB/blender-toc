...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "D8606BC1715AB279B8C33B7911DA98C6";
  static const uint8_t binary_fingerprint[16]; // = {0xD8,0x60,0x6B,0xC1,0x71,0x5A,0xB2,0x79,0xB8,0xC3,0x3B,0x79,0x11,0xDA,0x98,0xC6};

...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "1261848050785C379095CD667F4B21F1";
  static const uint8_t binary_fingerprint[16]; // = {0x12,0x61,0x84,0x80,0x50,0x78,0x5C,0x37,0x90,0x95,0xCD,0x66,0x7F,0x4B,0x21,0xF1};

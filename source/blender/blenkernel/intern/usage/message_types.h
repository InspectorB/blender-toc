...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "3A693C4CEFE2A8410B05AFF6274C7751";
  static const uint8_t binary_fingerprint[16]; // = {0x3A,0x69,0x3C,0x4C,0xEF,0xE2,0xA8,0x41,0x0B,0x05,0xAF,0xF6,0x27,0x4C,0x77,0x51};

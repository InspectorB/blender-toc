...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "28DB86BA1CBF1303990E1877CA07C8B0";
  static const uint8_t binary_fingerprint[16]; // = {0x28,0xDB,0x86,0xBA,0x1C,0xBF,0x13,0x03,0x99,0x0E,0x18,0x77,0xCA,0x07,0xC8,0xB0};

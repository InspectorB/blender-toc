...
class Message {
 public:
  ...
  static const char* ascii_fingerprint; // = "242243FA7519326619582531852AE481";
  static const uint8_t binary_fingerprint[16]; // = {0x24,0x22,0x43,0xFA,0x75,0x19,0x32,0x66,0x19,0x58,0x25,0x31,0x85,0x2A,0xE4,0x81};

...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "610753F6ED206BB73F5C8E66E358FC12";
  static const uint8_t binary_fingerprint[16]; // = {0x61,0x07,0x53,0xF6,0xED,0x20,0x6B,0xB7,0x3F,0x5C,0x8E,0x66,0xE3,0x58,0xFC,0x12};

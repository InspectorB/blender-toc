...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "B81D2AE2A8DCFF470A9B093573DE5138";
  static const uint8_t binary_fingerprint[16]; // = {0xB8,0x1D,0x2A,0xE2,0xA8,0xDC,0xFF,0x47,0x0A,0x9B,0x09,0x35,0x73,0xDE,0x51,0x38};

...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "54444018E67062166BC7E7A3E16B7C14";
  static const uint8_t binary_fingerprint[16]; // = {0x54,0x44,0x40,0x18,0xE6,0x70,0x62,0x16,0x6B,0xC7,0xE7,0xA3,0xE1,0x6B,0x7C,0x14};

...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "403566AB5A8080B52272B3BE7B3B4298";
  static const uint8_t binary_fingerprint[16]; // = {0x40,0x35,0x66,0xAB,0x5A,0x80,0x80,0xB5,0x22,0x72,0xB3,0xBE,0x7B,0x3B,0x42,0x98};

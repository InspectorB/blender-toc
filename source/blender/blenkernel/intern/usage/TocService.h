...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "A8A8A323E414628EE7C1FAD8D356EC0D";
  static const uint8_t binary_fingerprint[16]; // = {0xA8,0xA8,0xA3,0x23,0xE4,0x14,0x62,0x8E,0xE7,0xC1,0xFA,0xD8,0xD3,0x56,0xEC,0x0D};

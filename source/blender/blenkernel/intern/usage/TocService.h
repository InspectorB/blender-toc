...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "9D91A576806872C43D301CF835EAAEFF";
  static const uint8_t binary_fingerprint[16]; // = {0x9D,0x91,0xA5,0x76,0x80,0x68,0x72,0xC4,0x3D,0x30,0x1C,0xF8,0x35,0xEA,0xAE,0xFF};

...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "6E5FB9173CF19B7BD53267CDCDD256DF";
  static const uint8_t binary_fingerprint[16]; // = {0x6E,0x5F,0xB9,0x17,0x3C,0xF1,0x9B,0x7B,0xD5,0x32,0x67,0xCD,0xCD,0xD2,0x56,0xDF};

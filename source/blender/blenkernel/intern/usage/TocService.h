...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "E93C144D74112C17A7C4AE633030CF3B";
  static const uint8_t binary_fingerprint[16]; // = {0xE9,0x3C,0x14,0x4D,0x74,0x11,0x2C,0x17,0xA7,0xC4,0xAE,0x63,0x30,0x30,0xCF,0x3B};

...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "23D937C1FB233D5DF3C7C3E373223B09";
  static const uint8_t binary_fingerprint[16]; // = {0x23,0xD9,0x37,0xC1,0xFB,0x23,0x3D,0x5D,0xF3,0xC7,0xC3,0xE3,0x73,0x22,0x3B,0x09};

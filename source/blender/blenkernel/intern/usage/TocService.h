...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "2013EAD2F4CEB6C06DE9154B28312A28";
  static const uint8_t binary_fingerprint[16]; // = {0x20,0x13,0xEA,0xD2,0xF4,0xCE,0xB6,0xC0,0x6D,0xE9,0x15,0x4B,0x28,0x31,0x2A,0x28};

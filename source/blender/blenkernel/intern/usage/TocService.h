...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "4A2D7308BB77EA9A595E004308D880A9";
  static const uint8_t binary_fingerprint[16]; // = {0x4A,0x2D,0x73,0x08,0xBB,0x77,0xEA,0x9A,0x59,0x5E,0x00,0x43,0x08,0xD8,0x80,0xA9};

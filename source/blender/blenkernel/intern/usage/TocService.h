...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "80A3AD159FD08B49A825B4CAFD639279";
  static const uint8_t binary_fingerprint[16]; // = {0x80,0xA3,0xAD,0x15,0x9F,0xD0,0x8B,0x49,0xA8,0x25,0xB4,0xCA,0xFD,0x63,0x92,0x79};

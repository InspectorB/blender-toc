...
class TocService_sendMessage_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "C2F092061A540E662A160956DE910DA8";
  static const uint8_t binary_fingerprint[16]; // = {0xC2,0xF0,0x92,0x06,0x1A,0x54,0x0E,0x66,0x2A,0x16,0x09,0x56,0xDE,0x91,0x0D,0xA8};
